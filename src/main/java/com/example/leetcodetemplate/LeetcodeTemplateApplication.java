...
public class LeetcodeTemplateApplication {
    ...
    public static void main(String[] args) {
        ...
        int	        32	    4	        0	        [-2^31, 2^31-1] 即 -2147483648 ~ 2147483647 即负21亿 到 正21亿，负的精确值的绝对值比正的多1。
                                                     大概是 2 * 10^9, 10的8次方是1亿，10的9次方是10亿。
        long	    64	    8	        0L	        [-2^63, 2^63-1] 即 -9223372036854775808 ~ 922 3372 0368 5477 5807，负的精确值的绝对值比正的多1。
                                                     大概是 -9.2*10^18 ~ 9.2*10^18，数字长度为19，能保证取到 两int相乘、18位的999 和 9后面18个0。大约是922亿亿。
        float	    32	    4	        0f	        [-2^127, 2^127-1] 即 -3.4028235E+38 ~ 3.4028235E+38
        double	    64	    8	        0d	        [-2^1023, 2^1023-1] 但太大有精度问题，绝对值小于 2^53 (约10^15) 的整数都是可以精确表达，
                                                     这样说记整数double还不如long。
